...
class MobileNetV2(nn.Module):
    ...
    def _load_pretrained_model(self):
        pretrain_dict = torch.load('/mnt/workdir/fengwei/ultra_wide/DAUDA_IMAGE/beal/mobilenet_v2-6a65762b.pth')
...
if __name__ == "__main__":
    ...
    model = MobileNetV2(output_stride=16, BatchNorm=BatchNorm2d)
